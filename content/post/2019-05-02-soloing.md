...
It's important to practice your pentatonic scales (and learn how they connect) in every keys, not just C/Am. You should feel equally at home playing Em pentatonic, for example, as you are in Am, even though the locations of each position is utterly different. You need to **KNOW** where the roots are on the neck and within each position. You'll never get there if you don't practice in different keys.

I'd argue the most important keys for guitarists to learn first are the ones listed below (in this order). This is true whether you are using the full diatonic scales and modes, pentatonic scales, modes, or other altered scales.
...
If you practice these eight keys thoroughly, you'll find it easy to play in any of the remaining keys as well.

I've put them in this order based on the relative likelihood you'll play songs in those keys.
