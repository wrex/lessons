...
You need to **KNOW** where the roots are on the neck and be able to find the corresponding "boxes" or positions around each root note. You'll never get there if you don't practice in many different keys.
